...
mtext("Cross Validation Rate",side=2,line=2.5)
box()
...
#axis(1,range(pretty(regularizationThresholds),100))
mtext("Regularization Threshold", side=1, col="green",line=2.5)


#axis(3, pretty(range(finalModel$model$nonzero),200))
axis(3, at=c(1:100),labels=finalModel$model$nonzero)
mtext("Number of Features", side=3, col="magenta",line=2.5)
#text(314,labels="Cutoff")
abline(v=88, col="orange", lty=2)


#par(new=TRUE)
#plot(cvMinima$cv.min, 
#     axes=FALSE,
#     xlab="",ylab="",
#     col="green")
...
#plot(cvMinima$cv.1se, 
#     axes=FALSE,
#     xlab="",ylab=""
#     , pch=7)

#text(2,labels="x",plot=2)
```
