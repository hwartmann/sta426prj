...
mtext("Cross Validation Rate",side=2,line=2.5, col='red')
box()
...
mtext("FDRate",side=4,line=4, col='blue')
box()
...
mtext("Regularization Threshold", side=1, col="green",line=2.5)

axis(3, at=c(1:100),labels=finalModel$model$nonzero)
mtext("Number of Features", side=3, col="magenta",line=2.5)

abline(v=cvMinima$cv.min.index, col="orange", lty=2)

#Plotting cvmin

par(new=TRUE)
points(cvMinima$cv.min.index, thresholdCVRates$cvm[cvMinima$cv.min.index],
     axes=FALSE,
     xlab="",ylab="",
     col="green")
```
